...
#define LCD_ADDR ((U32)LCD_BUFFER)
	rLCDCON1 = (LCD_PIXCLOCK << 8) | (3 <<  5) | (12 << 1);
   	rLCDCON2 = (LCD_UPPER_MARGIN << 24) | ((LCD_HEIGHT - 1) << 14) | (LCD_LOWER_MARGIN << 6) | (LCD_VSYNC_LEN << 0);   //1 319 4 1
   	rLCDCON3 = (LCD_RIGHT_MARGIN << 19) | ((LCD_WIDTH  - 1) <<  8) | (LCD_LEFT_MARGIN << 0);   //  25  239  0
   	rLCDCON4 = (13 <<  8) | (LCD_HSYNC_LEN << 0);  //  13 4
